...
# load checkpoint
model_checkpoint = torch.load('./linguistic_style_transfer_pytorch/checkpoints/model_epoch_2.pt')
# Load model
...
# load index2word
with open("./linguistic_style_transfer_pytorch/utils/index2word.json") as f:
